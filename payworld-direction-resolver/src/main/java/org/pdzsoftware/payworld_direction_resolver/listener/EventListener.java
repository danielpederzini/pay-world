...
import org.pdzsoftware.payworld_direction_resolver.exception.AcknowledgeableException;
...
public class EventListener {
    ...
    public void onMessage(RawPaymentDTO message, @Header(KafkaHeaders.RECEIVED_KEY) String key, Acknowledgment ack) {
